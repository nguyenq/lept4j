...
public interface ILeptonica {
	...
	public static final int PIX_PAINT = 0xc | 0xa;
	public static final int PIX_MASK = 0xc & 0xa;
	public static final int PIX_SUBTRACT = 0xa & (0xc ^ 0x0f);
	public static final int PIX_XOR = 0xc ^ 0xa;
