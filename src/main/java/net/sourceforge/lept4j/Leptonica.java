...
//    int pixWriteStreamBmp(FILE fp, Pix pix);
     ...
     */
    Pix pixReadMemBmp(ByteBuffer data, NativeSize size);
...
//    int pixWriteStreamPng(FILE fp, Pix pix, float gamma);
     ...
     */
    Pix pixReadMemPng(ByteBuffer data, NativeSize size);
...
//    L_Recoga recogaReadStream(FILE fp);
     ...
     */
    L_Recoga recogaReadMem(ByteBuffer data, NativeSize size);
...
//     */
//    int recogaWriteStream(FILE fp, L_Recoga recoga);
     ...
     */
    int recogaWriteMem(PointerByReference pdata, NativeSizeByReference psize, L_Recoga recoga);
...
//     */
//    int recogaIdentifyMultiple(L_Recoga recoga, Pix pixs, int nitems, int minw, int minh, int skipsplit, PointerByReference pboxa, PointerByReference ppixa, PointerByReference ppixdb, int debugsplit);
...
//     */
//    int recogSplitIntoCharacters(L_Recog recog, Pix pixs, int minw, int minh, int skipsplit, PointerByReference pboxa, PointerByReference ppixa, PointerByReference pnaid, int debug);
...
//     */
//    int recogSetScaling(L_Recog recog, int scalew, int scaleh, int templ_type);
...
//    int recogaFinishAveraging(L_Recoga recoga);
     ...
     */
    L_Recog recogTrainFromBoot(Pixa pixa, L_Recog recogboot, float minscore, int threshold, int scalew, int scaleh, int templ_type, int debug);
...
//     */
//    int recogTrainUnlabelled(L_Recog recog, L_Recog recogboot, Pix pixs, Box box, float minscore, int debug);
...
//    int recogPadTrainingSet(PointerByReference precog, int debug);
     ...
     */
    L_Recog recogMakeBootDigitRecog(int templ_type, int maxyshift, int display);
