...
//      int l_byteaWriteStream(FILE fp, L_Bytea ba, NativeSize startloc, NativeSize endloc);
    ...
    /**
     * Original signature : <code>PTA* pixGetOuterBorderPta(PIX*, BOX*)</code>
     */
...
//     */
//    Pointer ccbaWriteSVGString(CCBorda ccba);
    /**
     * Original signature :
     ...
     */
    int pixColorContent(Pix pixs, int rref, int gref, int bref, int mingray, PointerByReference ppixr, PointerByReference ppixg, PointerByReference ppixb);
...
//    Pix pixMaskOverColorRange(Pix pixs, int rmin, int rmax, int gmin, int gmax, int bmin, int bmax);
     ...
     */
    int pixHasHighlightRed(Pix pixs, int factor, float minfract, float fthresh, IntBuffer phasred, FloatBuffer pratio, PointerByReference ppixdb);

    /**
     * Original signature :
     * <code>l_ok pixHasHighlightRed(PIX*, l_int32, l_float32, l_float32, l_int32*, l_float32*, PIX**)</code>
     */
    int pixHasHighlightRed(Pix pixs, int factor, float minfract, float fthresh, IntByReference phasred, FloatByReference pratio, PointerByReference ppixdb);
...
//       */
//      int pixelFractionalShift(int rval, int gval, int bval, float fract, IntBuffer ppixel);
//    /**
//     * Original signature :
//     * <code>PIX* pixMapWithInvariantHue(PIX*, PIX*, l_uint32, l_float32)</code>
//     */
//    Pix pixMapWithInvariantHue(Pix pixd, Pix pixs, int srcval, float fract);
//  
//      /**
...
//     */
//    int pixcmapIsValid(PixColormap cmap, Pix pix, IntBuffer pvalid);
//      /**
//       * Original signature :
...
//     */
//    PixColormap pixcmapGrayToFalseColor(float gamma);
//      /**
//       * Original signature :
...
//      int pixcmapShiftByComponent(PixColormap cmap, int srcval, int dstval);
     ...
     */
    int makeRGBToIndexTables(int cqlevels, PointerByReference prtab, PointerByReference pgtab, PointerByReference pbtab);
...
//     */
//    void l_colorfillDestroy(L_Colorfill.ByReference pcf[]);
//
//    /**
//     * Original signature :
//     * <code>l_ok pixColorContentByLocation(L_COLORFILL*, l_int32, l_int32, l_int32, l_int32, l_int32, l_int32, l_int32, l_int32)</code>
//     */
//    int pixColorContentByLocation(L_Colorfill cf, int rref, int gref, int bref, int minmax, int maxdiff, int minarea, int smooth, int debug);
//
    /**
     * Original signature :
...
//    Pixa makeColorfillTestData(int w, int h, int nseeds, int range);
     ...
     */
    int pixaComparePhotoRegionsByHisto(Pixa pixa, float minratio, float textthresh, int factor, int n, float simthresh, PointerByReference pnai, PointerByReference pscores, PointerByReference ppixd, int debug);
     ...
     */
    int pixGenPhotoHistos(Pix pixs, Box box, int factor, float thresh, int n, PointerByReference pnaa, IntBuffer pw, IntBuffer ph, int debugindex);

    /**
     * Original signature :
     * <code>l_ok pixGenPhotoHistos(PIX*, BOX*, l_int32, l_float32, l_int32, NUMAA**, l_int32*, l_int32*, l_int32)</code>
     */
    int pixGenPhotoHistos(Pix pixs, Box box, int factor, float thresh, int n, PointerByReference pnaa, IntByReference pw, IntByReference ph, int debugindex);
     ...
     */
    int pixDecideIfPhotoImage(Pix pix, int factor, float thresh, int n, PointerByReference pnaa, Pixa pixadebug);
...
//    L_Dna pixConvertDataToDna(Pix pix);
     ...
     */
    Pointer reformatPacked64(String inarray, int insize, int leadspace, int linechars, int addquotes, IntBuffer poutsize);
...
//       */
//      int gplotAddPlot(GPlot gplot, Numa nax, Numa nay, int plotstyle, String plotlabel);
//      /**
//       * Original signature :
...
//      void ditherToBinaryLineLow(IntBuffer lined, int w, IntBuffer bufs1, IntBuffer bufs2, int lowerclip, int upperclip, int lastlineflag);
     ...
     */
    Pointer lheapGetElement(L_Heap lh, int index);
...
//     */
//    int makeGaussianKernelSep(int halfh, int halfw, float stdev, float max, PointerByReference pkelx, PointerByReference pkely);
//
//    /**
//     * Original signature :
...
//     */
//    int numaFindSortedLoc(Numa na, float val, IntBuffer pindex);
//      /**
//       * Original signature :
...
//    L_Compressed_Data l_generateJpegDataMem(ByteBuffer data, NativeSize nbytes, int ascii85flag);
    ...
    /**
     * Original signature : <code>l_ok pixResizeImageData(PIX*, PIX*)</code>
     */
    ...
    /**
     * Original signature : <code>l_ok pixCopyDimensions(PIX*, PIX*)</code>
     */
    ...
    /**
     * Original signature : <code>l_int32 pixCopyResolution(PIX*, PIX*)</code>
     */
    ...
    /**
     * Original signature : <code>l_int32 pixCopyInputFormat(PIX*, PIX*)</code>
     */
...
//     */
//    int pixAverageInRect(Pix pixs, Pix pixm, Box box, int minval, int maxval, int subsamp, FloatBuffer pave);
//  
//      /**
...
//       */
//      int pixaExtendArrayToSize(Pixa pixa, NativeSize size);
//  
...
//     */
//    int writeImageCompressedToPSFile(String filein, String fileout, int res, IntBuffer pindex);
//      /**
//       * Original signature :
...
//     */
//    int pixWriteCompressedToPS(Pix pix, String fileout, int res, int level, IntBuffer pindex);
//      /**
//       * Original signature :
...
//     */
//    int sreadHeaderSpix(IntBuffer data, NativeSize size, IntBuffer pwidth, IntBuffer pheight, IntBuffer pbps, IntBuffer pspp, IntBuffer piscmap);
//      /**
//       * Original signature :
...
//      Pointer returnErrorPtr(String msg, String procname, Pointer pval);
     ...
     */
    void leptSetStderrHandler(leptSetStderrHandler_handler_callback handler);

    /**
     * Original signature : <code>void lept_stderr(const char*, null)</code>
     */
    void lept_stderr(String fmt, PointerByReference varArgs1);
//      /**
//       * Original signature :
...
//     * <code>char* stringReplaceSubstr(const char*, const char*, const char*, l_int32*, l_int32*)</code>
//     */
//    Pointer stringReplaceSubstr(String src, String sub1, String sub2, IntBuffer ploc, IntBuffer pfound);
//
//    /**
//     * Original signature :
//     * <code>L_DNA* stringFindEachSubstr(const char*, const char*)</code>
//     */
//    L_Dna stringFindEachSubstr(String src, String sub);
//
//    /**
//     * Original signature :
//     * <code>l_int32 stringFindSubstr(const char*, const char*, l_int32*)</code>
...
//    int stringFindSubstr(String src, String sub, IntBuffer ploc);
     ...
     */
    Pointer reallocNew(PointerByReference pindata, NativeSize oldsize, NativeSize newsize);
//      /**
//       * Original signature :
...
//      NativeSize fnbytesInFile(FILE fp);
    ...
    /**
     * Original signature : <code>l_uint8* l_binaryCopy(l_uint8*, size_t)</code>
     */
