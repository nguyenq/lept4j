...
public class LeptonicaImpl implements Leptonica {
    ...
    @Override
    public Pointer encodeAscii85(ByteBuffer inarray, NativeSize insize, NativeSizeByReference poutsize) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public Pointer decodeAscii85(String inarray, NativeSize insize, NativeSizeByReference poutsize) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public Pointer encodeAscii85WithComp(ByteBuffer indata, NativeSize insize, NativeSizeByReference poutsize) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public Pointer decodeAscii85WithComp(String instr, NativeSize insize, NativeSizeByReference poutsize) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int readHeaderJp2k(String filename, IntBuffer pw, IntBuffer ph, IntBuffer pbps, IntBuffer pspp, IntBuffer pcodec) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int freadHeaderJp2k(FILE fp, IntBuffer pw, IntBuffer ph, IntBuffer pbps, IntBuffer pspp, IntBuffer pcodec) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int readHeaderMemJp2k(ByteBuffer data, NativeSize size, IntBuffer pw, IntBuffer ph, IntBuffer pbps, IntBuffer pspp, IntBuffer pcodec) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int pixWriteStreamJp2k(FILE fp, Pix pix, int quality, int nlevels, int codec, int hint, int debug) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public Pix pixCleanImage(Pix pixs, int contrast, int rotation, int scale, int opensize) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int getPdfPageCount(String fname, IntBuffer pnpages) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int getPdfPageSizes(String fname, PointerByReference pnaw, PointerByReference pnah, IntBuffer pmedw, IntBuffer pmedh) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int getPdfMediaBoxSizes(String fname, PointerByReference pnaw, PointerByReference pnah, IntBuffer pmedw, IntBuffer pmedh) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int getPdfRendererResolution(String infile, String outdir, IntBuffer pres) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int pixFreeAndSetData(Pix pix, IntByReference data) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int pixSetData(Pix pix, IntByReference data) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public IntByReference pixExtractData(Pix pix) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int pixGetPixel(Pix pix, int x, int y, IntByReference pval) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int pixGetRGBPixel(Pix pix, int x, int y, IntByReference prval, IntByReference pgval, IntByReference pbval) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int lept_floor(float fval) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public int lept_ceiling(float fval) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    @Override
    public int getFormatFromExtension(String extension) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
